    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        for (var i = 0, len = data.length; i < len; i++) {
          ...
          var positionMapping = ['asset_bbgId', 'asset_type', 'asset_bbgTicker', 'underlying_bbgId', 'underlying_internalId', 'underlying_type' , 'underlying_bbgTicker', 'underlying_name', 'asset_multiplier', 'asset_priceLast', 'underlying_country', 'underlying_region', 'underlying_currency', 'underlying_sector', 'underlying_industry', 'underlying_gicsSector', 'underlying_gicsIndustry', 'underlying_currencyOverride', 'position_id' , 'asset_priceClose', 'position_current', 'position_side', 'position_close', 'position_custodyProvider', 'position_custodyAccount', 'position_ntcfIntraday', 'position_pnlDailyLocal', 'position_pnlFxRate', 'position_pnlDailyBase', 'derivative_optionCallPut' , 'derivative_optionStrike', 'derivative_Maturity', 'derivative_premiumLastBase', 'derivative_deltaUnderlying' , 'position_deltaSide', 'position_exposureLongBase', 'position_exposureShortBase', 'derivative_vega', 'derivative_theta', 'underlying_priceLast', 'derivative_volatiltyImplied', 'derivative_deltaPct', 'position_exposureNetBase', 'position_exposureGrossBase', 'tag'];
